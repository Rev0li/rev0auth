    ...
    <main class="page-content">
        ...
        <section class="section" id="section-services">
            ...
            <div class="services-grid">
                ...
                <div class="svc-card ss-svc-card" id="songsurf-card">
                    <div class="ss-svc-header">
                        <span class="ss-svc-badge">♪ SongSurf</span>
                        <span class="ss-svc-status" id="ss-svc-status"></span>
                    </div>
